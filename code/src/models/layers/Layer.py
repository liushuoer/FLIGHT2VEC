...
class Transformer_Layer(nn.Module):
    ...
    def forward(self, x):
        ...
        # [bs x nvars x d_model x num_patch]
        # 将 inter_out 转换为目标形状
        inter_out = inter_out.view(b, nvar, patch_num, dim)  # [bs, nvars, num_patch, d_model]
        inter_out = inter_out.permute(0, 1, 3, 2)  # [bs, nvars, d_model, num_patch]
