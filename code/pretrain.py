...
from src.learner import Learner, transfer_weights, Flight2VecLoss
...
parser.add_argument('--dset_pretrain', type=str, default='aircraft', help='dataset name')
...
def pretrain_func(lr=args.lr):
    ...
    cbs += [
        PatchMaskCB(patch_len=args.patch_len, stride=args.stride,
                   ...
                   behavior_adaptive=True,  # Enable behavior-adaptive patching
