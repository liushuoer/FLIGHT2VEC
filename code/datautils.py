...
DSETS = ['ettm1', 'ettm2', 'etth1', 'etth2', 'electricity',
         'traffic', 'illness', 'weather', 'exchange', 'aircraft'
        ]
...
def get_dls(params):
    ...
    elif params.dset == 'aircraft':
        root_path = '/Users/shuoliu/Downloads/pathformer-main/Flight2Vec/dataset/'
        size = [params.context_points, 0, params.target_points]
        dls = DataLoaders(
                datasetCls=Dataset_aircraft,
                dataset_kwargs={
                'root_path': root_path,
